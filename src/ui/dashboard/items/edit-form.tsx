    ...
    return (
        <form action={dispatch}>
            <div>
                ...
                <TextInput id="name" name="name" type="text" placeholder="Item name..." defaultValue={item.name} error={!!state.errors?.name} errorMessage={state.errors?.name?.join('\n')} />
            </div>
            <div className="mt-4 mb-3">
                ...
                <NumberInput id="quantity" name="quantity" min={0} placeholder="Quantity of item..." defaultValue={item.quantity} error={!!state.errors?.quantity} errorMessage={state.errors?.quantity?.join('\n')} /> 
            </div>
            <div className="mt-4 mb-3">
                ...
                <Switch id="consumable" name="consumable" defaultChecked={item.consumable} error={!!state.errors?.consumable} errorMessage={state.errors?.consumable?.join('\n')} /> 
            </div>
